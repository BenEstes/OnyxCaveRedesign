                ...
                <div className="info-container">
                    <div className='info-inner-container'>
                        <h1>Onyx Cave Information</h1>
                            <img src={ImageHelper.BusinessPreview2} alt='Business front' className='info-image' />
                    ...
                    <div className='info-inner-container'>
                        <h1>Inside Onyx Cave</h1>
                            <img src={ImageHelper.CaveTourSights5} alt='Cave tour preview.' className='info-image' /> 
